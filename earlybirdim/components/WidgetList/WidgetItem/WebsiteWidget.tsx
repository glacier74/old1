    ...
    return (
      <div className="flex h-full">
        ...
        {imageUrl ? (
          ...
          <WebsiteWidget.ImagePlaceholder className="ml-6 aspect-[1.4] h-full" />
        ) : null}
      </div>
    )
  }
    ...
    return (
      <div className="flex h-full flex-col">
        ...
        {imageUrl ? (
          ...
          <WebsiteWidget.ImagePlaceholder className="mt-6 aspect-[40/21]" />
        ) : null}
      </div>
    )
  }

  private static ImagePlaceholder({ className }: ComponentProps) {
    return (
