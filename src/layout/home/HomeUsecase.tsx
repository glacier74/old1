    ...
    <section className="relative grid md:grid-cols-2">
      <div className="bg-emerald-400/20 sm:py-48 py-16">
        <div className="px-8 md:pr-32">
          <div className="flex justify-end">
            <div>
              <h2 className="sm:text-4xl text-2xl font-bold sm:mb-8 mb-4">EarlyBird is for</h2>
              <ul className="list-disc sm:text-xl text-lg pl-4 leading-loose sm:space-y-2 space-y-1">
      ...
      <div className="bg-yellow-300/10 sm:py-48 py-16">
        <div className="px-8 md:pl-32">
          <h2 className="sm:text-4xl text-2xl font-bold mb-8">EarlyBird is NOT for</h2>
          <ul className="list-disc sm:text-xl text-lg pl-4 leading-loose sm:space-y-2 space-y-1">
