    ...
    <section className="relative pb-0 bg-slate-50">
      <div className="py-32 px-4 md:px-8 max-w-4xl mx-auto">
        ...
        <div className="mt-8 shadow-xl p-8 md:p-16 text-xl md:text-2xl tracking-wide font-medium text-slate-900 space-y-4 rounded-lg antialiased">
          ...
          <p>With EarlyBird, it is easy for anyone to validate their idea, and you don't need coding skills. You can create a beautiful landing page in just 10 minutes, add a conversion action block, and you are ready to attract potential customers. </p>
          <p>If any of them show interest in your idea and are willing to pay, it's a sign that your concept is successful. Well done on completing the idea validation process! </p>
