...
export const HomeFeature: FC = () => (
  <>
    <section className="bg-mystic-50 grid md:grid-cols-2">
      ...
      <div className="px-8">
        <div className="py-8 md:py-32">
          ...
          <div className="mt-5 mb-7 max-w-xl text-xl md:text-2xl leading-tight text-slate-800">
    ...
    <section className="grid md:grid-cols-2">
      ...
      <div className="flex items-center py-8 md:py-32 px-8 md:pr-32">
        <div className="max-w-xl mx-auto">
          ...
          <div className="mt-5 mb-7 w-full text-xl md:text-2xl leading-tight text-slate-800">
