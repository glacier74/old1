      ...
      <div className="max-w-7xl mx-auto px-5 grid md:grid-cols-4 gap-4 place-items-center">
        <div className="col-span-2">
            <div className="py-16 md:py-24 px-8 text-slate-900">
                ...
                Ensure that your product or business idea has potential and that the most critical assumptions regarding the idea are valid.
                </div>
                <div className="mt-8">
                    <div>
                    ...
                    <div className="mt-4">
                        <h3 className="text-lg font-medium mb-2">EarlyBird is <span className="font-bold">NOT</span> for</h3>
                            <ul className="list-disc text-base pl-4 leading-loose">
