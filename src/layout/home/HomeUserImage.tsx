...
export const HomeUserImage: FC = () => {
  ...
  return (
    <section className="relative py-32">
      <h2 className="max-w-3xl mx-auto text-3xl md:text-5xl font-bold text-center">
        ...
        <div className="col-span-2">
          <div className="py-4 md:py-8 px-4 text-slate-900">
            <div className='w-full mt-8'>
              <h3 className='text-xl font-bold mb-2'>🕒 How long could it take you to launch a new business?</h3>
              <p>It could range from a week to a year, depending on the individual.</p>
              <h3 className='text-xl font-bold mt-8 mb-2'>💰 And how much would it cost?</h3>
              <p>It could cost anywhere from hundreds to thousands of dollars, or even more.</p>
              <p className='mt-8'>It's important to be mindful of your time and money when starting a business. <span className='font-bold'>You don't want to regret wasting either of them.</span></p>
              <p className='mt-4'>So what if you could build a landing page in 10 minutes for free to test if people are truly interested in what you are creating?</p>
