        ...
        <div className="col-span-2">
          <div className="py-4 md:py-8 px-4 text-slate-900">
            <div className='w-full mt-8'>
              <h3 className='text-2xl font-medium mb-2'>🕒 How long could it take to launch a business?</h3>
              ...
              <p className='text-xl font-medium mt-8'>So what if you could build a landing page in 10 minutes to test if people are truly interested in what you are creating?</p>
              <p className="mt-4">Read story 👉 <Link
