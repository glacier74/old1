  ...
  return (
    <section className="xl:py-24 md:py-16 py-12 md:px-12 px-6 z-10">
      <div className="max-w-3xl mx-auto">
        <p className="text-xl leading-normal text-slate-700 mb-2">
          ...
          can be a time sink, so we built EarlyBird as a no-code solution to fix that problem.
        </p>
        <p className="text-xl leading-normal text-slate-700">
          We've been growing steadily since launch, and now have thousands of users throughout the
          world using our landing page builder to validate their ideas and transform them into
          successful ventures.
        </p>
      </div>
    </section>
