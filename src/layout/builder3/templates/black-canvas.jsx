    ...
    "fields": [
      {
        ...
        "type": "text",
        "ai": true,
        "default": "👋 Hello, I am a indie hacker and dadpreneur building bootstrapped micro SaaS products. I believe in learning through practice and embracing failure."
      },
      {
        "name": "image",
        "title": "Image",
        "type": "image",
        "default": "https://images.unsplash.com/photo-1519764622345-23439dd774f7?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=687&q=80"
      },
      {
        "name": "social_links",
        "title": "Social Links",
        ...
        "default": [
          {
            ...
            "description": "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum ullamcorper mauris at ligula fermentum, eget lacinia nunc euismod. Donec id elit non mi porta gravida at eget metus.",
            "date": "2022/12"
          },
          {
            "title": "TinySnap",
            "link": "https://tinysnap.app",
            "description": "Proin eget tortor risus. Curabitur non nulla sit amet nisl tempus convallis quis ac lectus. Pellentesque in ipsum id orci porta dapibus.",
            "date": "2022/09"
          },
          {
            "title": "HeyForm",
            "link": "https://heyform.net",
            "description": "Nulla porttitor accumsan tincidunt. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia curae; Donec velit neque, auctor sit amet aliquam vel, ullamcorper sit amet ligula.",
            "date": "2022/05"
          }
        ]
      }
	...
	<div>
		<div className="earlybird-1ETfnx min-h-screen bg-slate-950 text-white flex flex-col items-center">
			...
			<div className="earlybird-zNZErc lg:max-w-[1280px] max-w-[768px] fixed w-full px-8 py-10 flex flex-col z-50 lg:bg-transparent bg-slate-950">
				<h1 className="earlybird-FqN2Kn text-3xl font-bold md:mb-2 mb-0 mr-1">{header.title}</h1>
					...
					{made.list.map((item, key) => (
						<div key={key} className="earlybird-PPMmTO mb-12 flex lg:flex-row flex-col">
							<div className="earlybird-VHDE2b lg:py-8 lg:-rotate-90 h-fit">
								<span className="earlybird-CXGYu3 text-xs ml-auto text-slate-400">{item.date}</span>
							</div>
							<div>
								<a href={item.link}>
								...
								<p className="earlybird-s5acAh text-lg text-slate-300/80">{item.description}</p>
							</div>
						</div>
					))}
				</div>
