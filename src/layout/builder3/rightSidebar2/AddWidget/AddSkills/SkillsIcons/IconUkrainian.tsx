...
export const IconUkrainian: FC<SVGProps<SVGSVGElement>> = props => {
  return (
    <svg
      width="16"
      height="16"
    ...
    >
      <g clipPath="url(#clip0_36_105)">
        ...
        <path
          ...
          fill="#FFDA44"
        />
        <path d="M3 8C3 5.23858 5.23858 3 8 3C10.7614 3 13 5.23858 13 8" fill="#338AF3" />
      </g>
      <defs>
