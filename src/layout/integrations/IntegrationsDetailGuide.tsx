...
export const IntegrationsDetailGuide: FC = () => {
  const { t } = useTranslation()

  return (
    <section className="bg-slate-50 py-16">
      <div className="relative max-w-5xl mx-auto px-6 sm:py-20 py-10 z-10 text-center">
        <h3 className="sm:text-4xl text-2xl font-bold mb-4">How to connect EarlyBird <span className="text-emerald-500">+</span> Slack</h3>
        <p className="text-xl text-slate-700 mb-8">Integrating EarlyBird with Slack is easy and keeps your team in the loop at all times.</p>
        ...
        <div className="flex flex-wrap mb-16">
            <div className="w-full md:w-1/3 p-4 flex flex-col items-center">
                <Image
                    ...
                    height={120}
                />
                <p className="px-3 text-slate-700">Ensure your form is pointed to a Basin endpoint and click 'add to Slack' from your form's Slack integration page.</p>
            </div>
            <div className="w-full md:w-1/3 p-4 flex flex-col items-center">
                <Image
                    ...
                    height={120}
                />
                <p className="px-3 text-slate-700">Once Basin is connected to your Slack workspace, choose which channel to post your form submissions to.</p>
            </div>
            <div className="w-full md:w-1/3 p-4 flex flex-col items-center">
                <Image
                    ...
                    height={120}
                />
                <p className="px-3 text-slate-700">Once settings are saved, all new submissions to your form will be posted to your Slack channel automatically.</p>
            </div>
        </div>
