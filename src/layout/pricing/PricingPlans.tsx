    ...
    <section>
      <div className="max-w-7xl mx-auto">
        <div className="sm:flex sm:flex-col sm:align-center">
            ...
            {tiers.map((tier) => (
                <div key={tier.name} className="border border-slate-700 rounded-lg shadow-sm divide-y divide-slate-800">
                <div className="p-6">
                ...
                <div className="pt-6 pb-8 px-6">
                    ...
                    {tier.includedFeatures.map((feature) => (
                        ...
                        <IconCheck className="flex-shrink-0 h-5 w-5 text-green-400" aria-hidden="true" />
