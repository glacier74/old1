    ...
    <section className="relative pb-0 bg-emerald-100">
      <div className="max-w-5xl mx-auto px-5">
        <div className="py-32 text-slate-900">
          ...
          <div className="max-w-3xl mx-auto mt-4 text-lg md:text-xl text-center leading-snug text-slate-500">
          ...
          <div className="flex justify-center mt-8">
            <Link
              href="/sign-up"
              className="px-6 py-2 md:px-8 md:py-3 bg-emerald-500 border border-emerald-500 rounded-md text-white"
            >
              Sign up free
            </Link>
          </div>
