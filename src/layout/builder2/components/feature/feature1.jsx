    ...
    <div className="feature__container">
      <div className="feature__wrapper">
        <div className="feature__header">
          <Html as="p" className="feature__caption" {...data.setting.Html1} />
          <H2 className="feature__title" {...data.setting.H21} />
          <Html as="p" className="feature__subtitle" {...data.setting.Html2} />
        </div>

        <div className="feature__list">
          <List className="feature__list-wrapper">
            {data.setting.List1?.map(List1 => (
              <Group as="li" className="feature__list-item" key={List1.id}>
                <Icon className="feature__item-icon" {...List1.Group1.Icon1} />

                <H3 className="feature__item-title" {...List1.Group1.H31} />

                <Html className="feature__item-subtitle" {...List1.Group1.Html1} />
              </Group>
            ))}
          </List>
        </div>
