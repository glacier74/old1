import { $Block as Block, $Group as Group, $H1 as H1, $Html as Html, $Image as Image, ImageSwiper, $List as List } from "@earlybirdim/blocks";
      ...
      <Block productId={productId} block={block}>
        <div className="image_gallery1__container">
          <div className="image_gallery1__wrapper">
            ...
            {block.setting.List1?.map(List1 => <Group as="li" key={List1.id}>
